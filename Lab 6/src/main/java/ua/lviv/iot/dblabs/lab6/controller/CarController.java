...
import ua.lviv.iot.dblabs.lab6.dto.CarDTO;
import ua.lviv.iot.dblabs.lab6.dto.RentDTO;
import ua.lviv.iot.dblabs.lab6.dto.assembler.CarDTOAssembler;
...
public class CarController {
    ...
    public ResponseEntity<Double> getAveragePrice() {
        Double averagePrice = carService.getAverageCarPrice();
        return new ResponseEntity<>(averagePrice, HttpStatus.OK);
    }

    @GetMapping("/car_cursor/")
    public ResponseEntity<?> carCursor() {
        carService.carCursorProcedure();
